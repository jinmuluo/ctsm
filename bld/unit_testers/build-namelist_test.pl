...
foreach my $options ( "-drydep --bgc sp", "-megan --bgc sp", "-drydep -megan --bgc bgc", "-fire_emis --bgc bgc", "-drydep -megan -fire_emis --bgc bgc", "-fan full -bgc bgc -crop" ) {
   &make_env_run();
...
foreach my $driver ( "nuopc" ) {
   ...
   foreach my $options ( "-res 0.9x1.25 -configuration nwp",
                         ...
                         "-res 0.9x1.25 -envxml_dir . -infile myuser_nl_clm",
